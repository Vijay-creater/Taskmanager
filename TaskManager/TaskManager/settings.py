...
SECRET_KEY = 'django-insecure-p-oka%7fxigxmt#i#09pwt6-13h48y_w2nhrd*5ea94job4@c7'
...
REST_KNOX = {
    ...
    'TOKEN_TTL': timedelta(days=30), # The default is 10 hours i.e., timedelta(hours=10)).
